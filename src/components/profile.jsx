...
const Profile = () => {
  ...
  return (
    <div style={{
        ...
        {isMobileMenuOpen && (
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <a href="#" style={{ color: '#2563eb', fontWeight: '600', textDecoration: 'none' }}>Profile</a>
            </div>
          </div>
        )}
      </nav>
      ...
      {/* Main Content */}
      <main style={{ maxWidth: '1280px', margin: '0 auto', padding: '60px 16px' }}>
        {/* Hero Section */}
        <div style={{
          textAlign: 'center',
          marginBottom: '80px',
          ...
          <p style={{
            ...
            Create a comprehensive professional profile to showcase your skills and accelerate your job search journey.
          </p>
          
          <div className={`status-badge ${hasProfile ? 'status-complete' : 'status-pending'}`}>
            {hasProfile ? (
              <>
                <CheckCircle size={16} />
            ...
            {!hasProfile ? (
              ...
              >
                ...
                <p style={{
                  ...
                  Upload your resume and build a comprehensive profile to get discovered by top employers
                </p>
                <div style={{
                  display: 'flex',
                  alignItems: 'center',
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            ...
            <p style={{
              ...
              Enhance your profile and accelerate your job search with these powerful tools
            </p>
          </div>
          ...
          <div style={{
            ...
            onMouseOut={(e) => {
              ...
              <p style={{
                ...
                Take skill tests to validate your expertise and boost credibility
              </p>
            </div>
