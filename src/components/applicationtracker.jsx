    ...
    <>
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto">
              <li className="nav-item">
                <a className="nav-link" href="applicationtracker.html">
                  Application Tracker
                </a>
              </li>
              <li className="nav-item">
      ...
      <section className="hero d-flex align-items-center">
        <div className="container d-flex align-items-center justify-content-between">
          <div>
            <h1 className="display-4">Track your job search. Get hired faster.</h1>
            <p className="lead">
             Simplify automatically saves job applications you submit to help you manage your<br/> job search and follow up at the right time, every time.
            </p>
            <a
              href="#"
